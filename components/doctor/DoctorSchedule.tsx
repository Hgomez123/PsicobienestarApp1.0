      ...
      <div className="flex items-start justify-between gap-3 flex-wrap">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          {confirmDelete === appt.id ? (
            ...
            <button aria-label="Eliminar cita" onClick={() => onConfirmDelete(appt.id)} className="rounded-xl border border-red-100 bg-red-50 px-3 py-1 text-xs text-red-500 hover:bg-red-100 transition">✕</button>
          )}
        </div>
      </div>
    </div>
