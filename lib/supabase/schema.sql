...
-- NOTA: el bloqueo del cambio de rol lo hace el trigger
-- profiles_prevent_role_change (ver sección TRIGGERS). La policy
-- WITH CHECK subquery-based se evitó a propósito porque puede leer
-- valores post-update en algunas versiones de Postgres.
